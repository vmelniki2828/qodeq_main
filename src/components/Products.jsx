...
function Products() {
  ...
  useEffect(() => {
    // Initialize LiveChat widget only once
    if (!window.__lc) {
      window.__lc = window.__lc || {};
      window.__lc.license = 19304772;
    ...
    const timer = setTimeout(() => {
      if (window.LiveChatWidget) {
        if (selectedId === 'chatbot') {
          // Show LiveChat widget for chatbot
          window.LiveChatWidget.call("minimize");
        } else {
          // Hide LiveChat widget for other products
          window.LiveChatWidget.call("hide");
        }
      }
    }, 1500);
                  ...
                  <div className="hero-content">
                    ...
                    >
                      ...
                      <audio 
                        ...
                        style={{ 
                          width: '320px',
                          opacity: activeAudio === 'audio-2' ? 1 : 0.7,
                          border: activeAudio === 'audio-2' ? '2px solid #00FF85' : '2px solid transparent'
                        }}
...
{t('calculateCostButton')}
      ...
      <noscript>
        <a href="https://www.livechat.com/chat-with/19304772/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechat.com/?welcome" rel="noopener nofollow noreferrer" target="_blank">LiveChat</a>
      </noscript>
    </div>
    </>
  );
